...
- Formats
	- [Text]
		+ Name:Article
		+ Tags:[Text]
		+ Format:.txt .pdf .doc .psd .epub .fb2 ->.epub
		+ Player:Book
		+ Tools:
			+ Change text,
	...
	- [Image][Bitmap]
		+ Name:Bitmap Image
		+ Tags:[Image][Bitmap]
		+ Format:.png .jpg .avi .jpeg .gif .psd .sai .pdf->.webp
		+ Player:Layer
		+ Tools:
	...
	- [Object]
		+ Name:3D object
		+ Tags:[Object]
		+ Format:.3ds .3mf .amf .assimp .awd .babylon .ctm .dae .drc .fbx .gcode .js .json .kmz .md2 .mmd .nrrd .obj .pcd .pdb .ply .prwm .sea .stl .svg .ttf .vrm .vtk .webm .wrl .x .blend .max->.gltf
		+ Player:3D scene
		+ Tools:
